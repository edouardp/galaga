...
MIGRATED_NOTEBOOKS = (
    ...
    "cga/interactive_cga2d.py",
    "cga/derived_circle_from_points.py",
    "cga/circle_circle_meet.py",
    ...
    "galaga_v2/bilinear_and_wedge_tables.py",
    "galaga_v2/inner_products.py",
    ...
    "annotation/sta_electromagnetism.py",
    "annotation/matrix_annotations.py",
    "annotation/sign_highlights.py",
    "annotation/content_parts.py",
    "annotation/subexpressions.py",
    "annotation/cga_marker_styles.py",
    "annotation/rga_object_styles.py",
    "annotation/pga_object_styles.py",
    "annotation/pga_decompositions.py",
    "annotation/reversion_explained.py",
    "annotation/exterior_algebra_inside_clifford.py",
    ...
    "matrix/general_gram_compact_foundations.py",
