...
| $\mathrm{Cl}^0(V)$, $\mathrm{Cl}^{\bar{0}}(V)$, or $\mathrm{Cl}^+(V)$ | Even subalgebra                   | Subspace of even-grade elements (grades 0, 2, 4, ...). Forms a subalgebra since even $\times$ even = even. The superscript $\bar{0}$ makes explicit that this is parity mod 2, not only grade 0 |
| $\mathrm{Cl}^1(V)$, $\mathrm{Cl}^{\bar{1}}(V)$, or $\mathrm{Cl}^-(V)$ | Odd subspace                      | Subspace of odd-grade elements (grades 1, 3, 5, ...). Not a subalgebra (odd $\times$ odd = even). The superscript $\bar{1}$ makes explicit that this is parity mod 2, not only grade 1 |
