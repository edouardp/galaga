...
| **galaga** | p, q, r (null last) | e1²=+1, e2²=+1, e3²=0 |
...
- **(r, p, q)** libraries (ganja.js, clifford, kingdon) place the null vector at the lowest index. This matches the common PGA convention where `e0` is the "origin" or "ideal" basis vector.
- **(p, q, r)** libraries (galaga, GeometricAlgebra.jl) place the null vector at the highest index. The null vector ends up named `e3` (or `v3` in Julia) rather than `e0`.
...
| galaga | `Algebra(1,3)` → e1²=+1, e2²=-1, e3²=-1, e4²=-1 | p then q |
