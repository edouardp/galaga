...
`tools.migrate_v2_notebooks.MIGRATED_NOTEBOOKS` is the single 51-file gallery
...
- Cost, because the Python 3.14 gate executes 51 notebooks and is heavier than
  a compile-only test.
